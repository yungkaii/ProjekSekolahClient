            ...
            <form action="proses.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="card card-custom p-4 shadow-sm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_sekolah" class="form-control" value="<?= htmlspecialchars($data['nama_sekolah']) ?>" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Logo Navbar</label><br>
                        <?php if(!empty($data['logo']) && file_exists('../assets/img/' . $data['logo'])): ?>
                            <img src="../assets/img/<?= htmlspecialchars($data['logo']) ?>" class="mb-2 rounded border border-secondary" height="60" style="object-fit: contain;">
                        <?php else: ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi_hero" class="form-control" rows="2"><?= htmlspecialchars($data['deskripsi_hero']) ?></textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Banner Utama</label><br>
                        <?php if(!empty($data['gambar_hero'])): ?>
                            <img src="../assets/img_sekolah/<?= htmlspecialchars($data['gambar_hero']) ?>" class="mb-2 rounded border border-secondary" width="150" style="object-fit: cover;">
                        <?php endif; ?>
                ...
                <div class="card card-custom p-4 shadow-sm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="isi_profil" class="form-control" rows="5"><?= htmlspecialchars($data['isi_profil']) ?></textarea>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="keunggulan_1" class="form-control" value="<?= htmlspecialchars($data['keunggulan_1'] ?? '') ?>" placeholder="Contoh: Fasilitas Lengkap">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Poin 2</label>
                            <input type="text" name="keunggulan_2" class="form-control" value="<?= htmlspecialchars($data['keunggulan_2'] ?? '') ?>" placeholder="Contoh: Guru Profesional">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Poin 3</label>
                            <input type="text" name="keunggulan_3" class="form-control" value="<?= htmlspecialchars($data['keunggulan_3'] ?? '') ?>" placeholder="Contoh: Biaya Terjangkau">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if(!empty($data['gambar_profil'])): ?>
                            <img src="../assets/img_sekolah/<?= htmlspecialchars($data['gambar_profil']) ?>" class="mb-2 rounded border border-secondary" width="100" style="object-fit: cover;">
                        <?php endif; ?>
                ...
                <div class="card card-custom p-4 shadow-sm">
                    <h5 class="section-title"><i class="bi bi-telephone-fill"></i> 4. Kontak & Sosial</h5>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="facebook" class="form-control" value="<?= htmlspecialchars($data['facebook']) ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Instagram URL</label>
                        <input type="url" name="instagram" class="form-control" value="<?= htmlspecialchars($data['instagram']) ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">YouTube URL</label>
                        <input type="url" name="youtube" class="form-control" value="<?= htmlspecialchars($data['youtube']) ?>">
                    </div>
                    <div class="mb-3">
                ...
                <button type="submit" name="update_profil" class="btn btn-primary w-100 py-2 fw-bold shadow mb-4">
